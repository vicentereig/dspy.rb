# ADR-003: Ruby-Idiomatic API Design for DSPy.rb

**Status**: Accepted  
**Date**: 2025-06-05  
**Author**: Vicente Reig  
**Original**: Blog post "Building Ruby-Idiomatic AI Applications with DSPy.rb"

## Context

When building DSPy.rb, we had a choice: create a direct port of the Python library or reimagine it through a Ruby lens.
