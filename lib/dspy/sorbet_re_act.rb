...
module DSPy
  ...
  class SorbetThought < DSPy::SorbetSignature
    ...
    input do |builder|
      ...
      builder.const :history, T::Array[T::Hash[Symbol, T.untyped]],
    ...
    output do |builder|
      ...
      builder.const :action_input, String,
  ...
  class SorbetReAct < SorbetPredict
    ...
    HistoryEntry = T.let(
      Struct.new(:step, :thought, :action, :action_input, :observation, keyword_init: true) do
        def to_h
          {
            step: step,
            thought: thought,
