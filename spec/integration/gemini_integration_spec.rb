...
RSpec.describe 'Gemini Integration', :vcr do
  ...
  describe 'basic text generation' do
    it 'generates text response', vcr: { cassette_name: 'gemini_basic_text' } do
      skip 'Requires GEMINI_API_KEY' unless api_key
  ...
  describe 'multimodal capabilities' do
    ...
    it 'raises error when trying to use URL images', vcr: { cassette_name: 'gemini_url_error' } do
      skip 'Requires GEMINI_API_KEY' unless api_key
    ...
    it 'raises error when trying to use detail parameter', vcr: { cassette_name: 'gemini_detail_error' } do
      skip 'Requires GEMINI_API_KEY' unless api_key
  ...
  describe 'vision model validation' do
    it 'allows vision-capable Gemini models', vcr: { cassette_name: 'gemini_vision_validation' } do
      skip 'Requires GEMINI_API_KEY' unless api_key
  ...
  describe 'error handling' do
    it 'handles authentication errors', vcr: { cassette_name: 'gemini_auth_error' } do
      ...
      }.to raise_error(DSPy::LM::AdapterError, /authentication failed/)
    end
