...
RSpec.describe 'GEPA Simple Optimization Integration', vcr: { cassette_name: 'gepa_simple_optimization' } do
  ...
  describe 'Simple optimization scenario' do
    it 'performs basic optimization without genetic algorithm', skip: 'Requires API key' do
  ...
  describe 'Trace collection during optimization' do
    it 'collects execution traces during simple optimization run', skip: 'Requires API key' do
      skip 'Requires OPENAI_API_KEY' unless ENV['OPENAI_API_KEY']
  ...
  describe 'Reflection analysis during optimization' do
    it 'generates reflection insights during optimization', skip: 'Requires API key' do
      skip 'Requires OPENAI_API_KEY' unless ENV['OPENAI_API_KEY']
      ...
      puts "Reflection diagnosis: #{reflection.diagnosis}"
      puts "Suggested improvements: #{reflection.improvements}"
      puts "Confidence: #{(reflection.confidence * 100).round}%"
    end
  end
end