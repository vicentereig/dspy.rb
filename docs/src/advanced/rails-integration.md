...
DSPy modules support `before`, `after`, and `around` lifecycle callbacks. For callback order and arguments, see [Module Runtime Context](/dspy.rb/core-concepts/module-runtime-context/#lifecycle-callbacks).
