---
layout: home
title: [DSPy.rb](https://github.com/vicentereig/dspy.rb) - Program LLMs, Don't Prompt Them
...
<div class="mx-auto max-w-2xl py-16 sm:py-24 lg:py-32">
  ...
  <div class="text-center">
    ...
    <p class="mt-6 text-lg leading-8 text-gray-600">Tired of copy-pasting prompts and hoping they work? [DSPy.rb](https://github.com/vicentereig/dspy.rb) lets you write modular, type-safe Ruby code that handles the LLM stuff for you. Test it, optimize it, ship it.</p>
...
<div class="mx-auto max-w-5xl px-6 lg:px-8">
  <div class="mx-auto max-w-3xl">
    <p class="text-sm text-gray-500 mb-8">[DSPy.rb](https://github.com/vicentereig/dspy.rb) is a Ruby port of Stanford's <a href="https://dspy.ai" class="underline">DSPy framework</a>, adapted to Ruby idioms and enhanced with production-ready features.</p>
    
    <h2 class="text-2xl font-bold text-gray-900 mb-6">Why programmatic prompts?</h2>
    <p class="text-lg text-gray-600 mb-12">Because prompt engineering is a nightmare. You tweak words, cross your fingers, and deploy. When it breaks in production (and it will), you're back to square one. [DSPy.rb](https://github.com/vicentereig/dspy.rb) fixes this by letting you define what you want, not how to ask for it.</p>
