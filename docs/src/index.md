...
<div class="mx-auto max-w-2xl py-16 sm:py-24 lg:py-32">
  ...
  <div class="text-center">
    ...
    <p class="mt-6 text-lg leading-8 text-gray-600">Tired of copy-pasting prompts and hoping they work? DSPy.rb lets you write modular, testable, type-safe, instrumentable Ruby code that handles the LLM stuff for you. Test it, optimize it, ship it. Repeat.</p>
...
<div class="mx-auto max-w-5xl px-6 lg:px-8">
  <div class="mx-auto max-w-3xl">
    <p class="text-sm text-gray-500 mb-8">DSPy.rb is a Ruby port of Stanford's <a href="https://dspy.ai" rel="noopener noreferrer" class="underline">DSPy framework</a>, adapted to Ruby idioms and enhanced with production-ready features.</p>
...
<div class="mx-auto max-w-7xl px-6 lg:px-8 py-16 bg-gray-50">
  <div class="mx-auto max-w-2xl lg:text-center mb-12">
    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Access to 200+ models across 5 providers</h2>
    <p class="mt-4 text-lg text-gray-600">One API, multiple providers. Switch between OpenAI, Google, Anthropic, local models, and more with a single line of code.</p>
  </div>
...
```
    ...
    <div class="mt-8 rounded-lg bg-dspy-ruby/5 p-6 ring-1 ring-dspy-ruby/20">
      <div class="flex items-start gap-x-3">
        <svg class="h-6 w-6 flex-none text-dspy-ruby mt-1" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="flex-1">
          <h4 class="text-base font-semibold text-gray-900">OpenRouter: 200+ models from multiple providers</h4>
          <p class="mt-2 text-sm text-gray-600">Access models from OpenAI, Anthropic, Google, Meta, Mistral, and more through a single unified API.</p>
<div markdown="1">
```ruby
DSPy.configure do |c|
  c.lm = DSPy::LM.new(
...
```
    ...
    <div class="mt-8 text-center">
      <a href="{{ '/getting-started/installation/#provider-setup' | relative_url }}" class="inline-flex items-center text-sm font-semibold text-dspy-ruby hover:text-red-700">
        Learn more about provider setup <span aria-hidden="true" class="ml-2">→</span>
      </a>
    </div>
  </div>
</div>
